...
def global_min_confidence_multilabel(df, model, training_budget, include_all_classes=False, dataset='animals'):
    ...
    print("unique targets global min confidence ", len(set(sampled_targets_unique)))
    print('samples - global min confidence: ', len(set(sampled_question_ids)))
    print('all_samples - global min confidence: ', len(question_ids))
