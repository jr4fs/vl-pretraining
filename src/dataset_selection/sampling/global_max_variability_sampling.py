...
def global_max_variability(df, model, training_budget, include_all_classes=False, dataset='animals'):
    ...
    if include_all_classes == True:
        ...
        save_path = 'src/dataset_selection/sampling/samples/'+model+'/'+dataset+'/global_max_variability/include_all_classes/'+'budget_'+str(training_budget)+'.pkl'
    else:
        save_path = 'src/dataset_selection/sampling/samples/'+model+'/'+dataset+'/global_max_variability/'+'budget_'+str(training_budget)+'.pkl'
    ...
    print("unique targets global max variability ", len(set(unique_targets)))
