...
def max_confidence(df, model, training_budget, include_all_classes=False, dataset='animals'):
    ...
    if include_all_classes == True:
        ...
        save_path = 'src/dataset_selection/sampling/samples/'+model+'/'+dataset+'/max_confidence/include_all_classes/seed_'+str(args.seed)+'/budget_'+str(training_budget)+'.pkl'
    else:
        save_path = 'src/dataset_selection/sampling/samples/'+model+'/'+dataset+'/max_confidence/seed_'+str(args.seed)+'/budget_'+str(training_budget)+'.pkl'
    ...
    print("unique targets max confidence per class: ", len(set(unique_targets)))
    print('samples - max confidence per class: ', len(set(sampled_question_ids)))
