...
def max_confidence(df, model, training_budget, include_all_classes=False, dataset='animals'):
    ...
    if include_all_classes == True:
        ...
        save_path = 'src/dataset_selection/sampling/samples/'+model+'/'+dataset+'/max_confidence/include_all_classes/'+'budget_'+str(training_budget)+'.pkl'
    else:
        save_path = 'src/dataset_selection/sampling/samples/'+model+'/'+dataset+'/max_confidence/'+'budget_'+str(training_budget)+'.pkl'
