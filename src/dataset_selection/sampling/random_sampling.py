...
def random_sampling(df, model, training_budget, include_all_classes=False, dataset='animals'):
    ...
    if include_all_classes == True:
        ...
        save_path = 'src/dataset_selection/sampling/samples/'+model+'/'+dataset+'/random/include_all_classes/seed_'+str(args.seed)+'/budget_'+str(training_budget)+'.pkl'
    else:
        save_path = 'src/dataset_selection/sampling/samples/'+model+'/'+dataset+'/random/seed_'+str(args.seed)+'/budget_'+str(training_budget)+'.pkl'
