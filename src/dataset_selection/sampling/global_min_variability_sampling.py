...
def global_min_variability(df, model, training_budget, include_all_classes=False, dataset='animals'):
    ...
    print("unique targets global min variability ", len(set(unique_targets)))
