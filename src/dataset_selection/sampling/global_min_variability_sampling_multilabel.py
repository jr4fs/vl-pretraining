...
def global_min_variability_multilabel(df, model, training_budget, include_all_classes=False, dataset='animals'):
    ...
    df_sorted = df.sort_values(by=['variability'], ascending=True)
    ...
    #     save_path = 'src/dataset_selection/sampling/samples/'+model+'/'+dataset+'/global_min_variability/include_all_classes/seed_'+str(args.seed)+'/budget_'+str(training_budget)+'.pkl'
    # else:
    save_path = 'src/dataset_selection/sampling/samples/'+model+'/'+dataset+'/global_min_variability/seed_'+str(args.seed)+'/budget_'+str(training_budget)+'.pkl'
    ...
    print("unique targets global min variability ", len(targets_excluded))
    print('samples - global min variability: ', len(set(sampled_question_ids)))
    print('all_samples - global min variability: ', len(question_ids))
