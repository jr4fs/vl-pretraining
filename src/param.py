...
def parse_args():
    ...
    parser.add_argument("--sampling_ids", type=str, default=None)
    ...
    # Datamaps
    parser.add_argument("--base_path", default='snap/vqa/LXR111/animals/vqa_lxr111_animals_fromScratch_20epochs_breeds/', type=str, help='Path to trained model')
    ...
    # Sampling - try changing all the defaults to none 
    ...
    parser.add_argument("--norm", default='gaussian_kde', type=str, help='pvals, gaussian_kde, gaussian, tophat, epanechnikov, exponential, linear, cosine')
