...
def parse_args():
    ...
    # Sampling
    parser.add_argument("--sampling_method", default='max_variability', type=str, help='Sampling algorithm - beta, random, max_variability, min_variability')
    ...
    parser.add_argument("--neptune_study_name", default='max_variability_seed965', type=str, help='name of optuna study')
