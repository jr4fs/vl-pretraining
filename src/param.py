...
def parse_args():
    ...
    parser.add_argument('--seed', type=int, default=388, help='random seed')
    ...
    # Sampling
    parser.add_argument("--sampling_method", default='global_max_variability', type=str, help='Sampling algorithm - beta, random, max_variability, min_variability')
    ...
    parser.add_argument("--neptune_study_name", default='global_random_seed965', type=str, help='name of optuna study')
